<!-- combobox_0 -> Включение сведений о дополнительных автобусах лицензиата -->
...
<table class="title">
	<tbody>
		<tr>
			<td>
				Заявление о включении в реестр лицензий сведений о дополнительных автобусах, приобретенных лицензиатом для осуществления лицензируемой деятельности</td>
		</tr>
	</tbody>
</table>
<table>
...
<table class="no-gap">
	<tbody>
		<tr>
			<td>
				Сведения о приобретенных лицензиатом дополнительных для осуществления лицензируемой деятельности автобусах представлены в Приложении № 1 к настоящему заявлению.</td>
		</tr>
		<tr>
			<td>
...
<table class="no-gap">
	<tbody>
		<tr>
			<td>
				2. Дата добавления сведений в реестр « <span class="underline in" style="width: 30px;"> </span> » <span class="underline in" style="width: 110px;"> </span> 20<span class="underline in" style="width: 20px;"> </span> г.</td>
		</tr>
		<tr>
			<td>
				Выписка из решения о включении сведения об автобусах в реестра № <span class="underline in minw50"> </span></td>
		</tr>
	</tbody>
</table>
<table>
...
<table class="no-gap">
	<tbody>
		<tr>
			<td>
				3. Во включении сведений об автобусах в реестр отказано « <span class="underline in" style="width: 30px;"> </span> » <span class="underline in" style="width: 110px;"> </span> 20<span class="underline in" style="width: 20px;"> </span> г.</td>
		</tr>
	</tbody>
</table>
<table>
