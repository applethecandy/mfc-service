While(true) {
	...
	IfExist, C:\Users\SmolyakovSV\Downloads\service.txt
	{
		...
		FileAppend, ”слуга: %title1%`n—сылка: http://cpgu.mfc-karelia.ru:8181/cpgu/formEditor?eid=%id1%&lid=%id1%, C:\Users\SmolyakovSV\Desktop\MFC-service\%owner%\%id1%\info.txt
		...
		if (count1 > 1) {
			...
			loop, %count1%
			{
				...
				FileAppend, %realtemplate1%, C:\Users\SmolyakovSV\Desktop\MFC-service\%owner%\%id1%\templates\%tname1% Ц %tvalue1%.ftl
			}
