<!-- combobox_0 -> Изменение сведений об автобусах лицензиата -->
...
<table class="title">
	<tbody>
		<tr>
			<td>
				Заявление об изменении сведений об автобусах лицензиата</td>
		</tr>
	</tbody>
</table>
<table>
...
<table>
	...
	<tbody>
		<tr>
			<td></td>
			<td class="boxes">
				<checkbox>${form.checkbox_8?has_content?then("V", "")}</checkbox>
			</td>
			<td>- Изменение государственного регистрационного номера автобуса </td>
		</tr>
		<tr>
			<td></td>
			<td class="boxes">
				<checkbox>${form.checkbox_9?has_content?then("V", "")}</checkbox>
			</td>
			<td>- Изменение срока действия договора аренды (лизинга) автобуса</td>
		</tr>
		<tr>
			<td></td>
			<td class="boxes">
				<checkbox>${form.checkbox_10?has_content?then("V", "")}</checkbox>
			</td>
			<td>- Вступление лицензиата в права владения автобусом</td>
		</tr>
	</tbody>
</table>
<table class="no-gap">
...
<table class="no-gap">
	<tbody>
		<tr>
			<td>1. Изменения в реестр лицензий на лицензируемую деятельность внесены <br> « <span class="underline in" style="width: 30px;"> </span> » <span class="underline in" style="width: 110px;"> </span> 20<span class="underline in" style="width: 20px;"> </span> г.</td>
		</tr>
	</tbody>
</table>
...
<table class="no-gap">
	<tbody>
		<tr>
			<td>2. В изменении сведений в реестре лицензий на лицензируемую деятельность отказано<br> « <span class="underline in" style="width: 30px;"> </span> » <span class="underline in" style="width: 110px;"> </span> 20<span class="underline in" style="width: 20px;"> </span> г.</td>
		</tr>
	</tbody>
</table>
...
<table class="center">
	<tbody>
		<tr>
			<td>
				Сведения об автобусах лицензиата, подлежащих изменению
			</td>
		</tr>
	</tbody>
</table>
