<!-- # combobox_0 -> заявление о внесении в список лиц, относящихся к коренным малочисленным народам Российской Федерации # -->
...
<table class="header right">
    <tr>
        <td></td>
        <td>Приложение N 6<br> к Административному регламенту предоставления государственной услуги по учету лиц,
...
<table class="title">
    <tr>
        <td>
            Заявление<br> о внесении в список лиц, относящихся к коренным<br> малочисленным народам Российской
            Федерации
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>1.1. Фамилия</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_0 28 />
        </td>
    </tr>
    <tr>
        <td>1.2. Имя</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_1 28 />
        </td>
    </tr>
    <tr>
        <td>1.3. Отчество<br>(при наличии)</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_2 28 />
        </td>
    </tr>
    <tr>
        <td>1.4 Дата рождения</td>
        <td class="boxes">
            <@print_slim form.ls1_datefield_0 2 />
            <b>&nbsp;·&nbsp;</b>
            <@print_slim form.ls1_datefield_0 2 3 />
            <b>&nbsp;·&nbsp;</b>
            <@print_slim form.ls1_datefield_0 2 8 />
        </td>
    </tr>
    <tr>
        <td>1.5. Место рождения</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_65 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_65 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_65 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_65 34 28+34*2 />
            </span>
        </td>
    </tr>
    <tr>
        <td>1.6. Пол</td>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_1?contains("Мужской")?then("V", "")}</slimbox>
            &nbsp;&nbsp;Мужской
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <slimbox>${form.ls1_combobox_1?contains("Женский")?then("V", "")}</slimbox>
            &nbsp;&nbsp;Женский
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                1.7.1. Серия и номер
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_3 4 /> 
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_4 6 /> 
                &nbsp;&nbsp;
                1.7.2. Дата выдачи
                &nbsp;&nbsp;
                <@print_slim form.ls1_datefield_1 2 />
                <b>&nbsp;·&nbsp;</b>
                <@print_slim form.ls1_datefield_1 2 3 />
                <b>&nbsp;·&nbsp;</b>
                <@print_slim form.ls1_datefield_1 2 8 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_5 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_5 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_5 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_5 34 28+34*2 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_6 3 />
            <b>&nbsp;-&nbsp;</b>
            <@print_slim form.ls1_textfield_6 3 3 />
        </td>
    </tr>
    <tr>
        <td>1.8. СНИЛС (при наличии)</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_7 3 0 />
            <b>&nbsp;-&nbsp;</b>
            <@print_slim form.ls1_textfield_7 3 4 />
            <b>&nbsp;-&nbsp;</b>
            <@print_slim form.ls1_textfield_7 3 8 />
            <b>&nbsp;&nbsp;</b>
            <@print_slim form.ls1_textfield_7 2 12 />
        </td>
    </tr>
    <tr>
        <td>1.9. ИНН (при наличии)</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_8 12 />
        </td>
    </tr>
    <tr>
        <td>1.10. Наименование коренного малочисленного народа</td>
        <td class="boxes">
            <@print_slim form.ls1_combobox_2?has_content?then(form.ls1_combobox_2, "") 20 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_combobox_2?has_content?then(form.ls1_combobox_2, "") 34 20 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes">
                ...
                &nbsp;&nbsp;
                содержатся в приложении N 1 к заявлению
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            Если сведения представляются более, чем на одного члена семьи, то для
            каждого члена семьи заполняется отдельное приложение N 1 к заявлению
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_1FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"post_index\":\"(.*?)\"")[0]?groups[1] 6 />
                <#else> <@print_slim "" 6 /> </#if>
                &nbsp;&nbsp;
                2.1.2. Субъект Российской
                Федерации (код)
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_9 2 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_1FullAddr?has_content>
                <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"region\":\"(.*?)\"")[0]?groups[1] 28 />
    ...
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_1FullAddr?has_content>
                <#if form.ls1_KLADR_1FullAddrJson?matches("\"city\":\"(.*?)\"")[0]?groups[1]?length != 0>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"city\":\"(.*?)\"")[0]?groups[1] 28 />
                <#else>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"town\":\"(.*?)\"")[0]?groups[1] 28 />
                </#if>
            <#else> <@print_slim "" 28 /> </#if>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_1FullAddr?has_content>
                <#if form.ls1_KLADR_1FullAddrJson?matches("\"street\":\"(.*?)\"")[0]?groups[1]?length != 0>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"street\":\"(.*?)\"")[0]?groups[1] 28 />
                <#else>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"town\":\"(.*?)\"")[0]?groups[1] 28 />
                </#if>
            <#else> <@print_slim "" 28 /> </#if>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_1FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"house\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_1FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"building1\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                <#else> <@print_slim "" 4 /> </#if>
                &nbsp;&nbsp;
                <span>
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_1FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_1FullAddrJson?matches("\"apartment\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                <#else> <@print_slim "" 4 /> </#if>
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes">
                <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_0?has_content?then("V", "")}</slimbox>
                &nbsp;&nbsp;
                <span>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_2FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"post_index\":\"(.*?)\"")[0]?groups[1] 6 />
                <#else> <@print_slim "" 6 /> </#if>
                &nbsp;&nbsp;
                2.2.2. Субъект Российской
                Федерации (код)
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_10 2 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_2FullAddr?has_content>
                <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"region\":\"(.*?)\"")[0]?groups[1] 28 />
            <#else> <@print_slim "" 28 /> </#if>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_2FullAddr?has_content>
                <#if form.ls1_KLADR_2FullAddrJson?matches("\"city\":\"(.*?)\"")[0]?groups[1]?length != 0>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"city\":\"(.*?)\"")[0]?groups[1] 28 />
                <#else>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"town\":\"(.*?)\"")[0]?groups[1] 28 />
                </#if>
            <#else> <@print_slim "" 28 /> </#if>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <#if form.ls1_KLADR_2FullAddr?has_content>
                <#if form.ls1_KLADR_2FullAddrJson?matches("\"street\":\"(.*?)\"")[0]?groups[1]?length != 0>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"street\":\"(.*?)\"")[0]?groups[1] 28 />
                <#else>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"town\":\"(.*?)\"")[0]?groups[1] 28 />
                </#if>
            <#else> <@print_slim "" 28 /> </#if>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_2FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"house\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                <#else> <@print_slim "" 4 /> </#if>
                &nbsp;&nbsp;
                <span>
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_2FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"building1\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                <#else> <@print_slim "" 4 /> </#if>
                &nbsp;&nbsp;
                <span>
                ...
                &nbsp;&nbsp;
                <#if form.ls1_KLADR_2FullAddr?has_content>
                    <@print_slim form.ls1_KLADR_2FullAddrJson?matches("\"apartment\":\"(.*?)\"")[0]?groups[1]?left_pad(4) 4 />
                <#else> <@print_slim "" 4 /> </#if>
            </span>
        </td>
    </tr>
...
<table>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_1?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
                3.1.1. Да
            </span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_2?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
                3.2.1. Да
            </span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_3?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_4?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_5?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_6?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_7?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_8?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_9?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_10?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_11?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_12?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_13?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_14?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_checkbox_15?has_content?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
...
<table>
    ...
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_11 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_11 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_11 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_11 34 28+34*2 />
            </span>
        </td>
    </tr>
    <tr>
        <td>3.4.2. ОГРН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_12 13 />
        </td>
    </tr>
    <tr>
        <td>3.4.3. ИНН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_13 12 />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_14 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_14 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_14 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_14 34 28+34*2 />
            </span>
        </td>
    </tr>
    <tr>
        <td>3.5.2. ОГРН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_15 13 />
        </td>
    </tr>
    <tr>
        <td>3.5.3. ИНН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_16 12 />
        </td>
    </tr>
</table>
...
<table class="no-gap">
    <tr class="inline">
        <td>Я, </td>
        <td class="underline">
            ${form.ls1_textfield_0}
            ${form.ls1_textfield_1}
            ${form.ls1_textfield_2}
        </td>
    </tr>
    <tr>
...
<table class="no-gap">
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_3?contains("Лично в руки")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
                Лично в руки
            </span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_3?contains("В электронном виде")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_3?contains("по месту жительства")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_3?contains("по месту пребывания")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
...
<table class="no-gap">
    <tr>
        ...
        <td class="boxes" style="justify-content: flex-end;">
            <@print_slim form.ls1_textfield_17 22 />
        </td>
    </tr>
</table>
...
<table class="no-gap">
    <tr>
        ...
        <td class="boxes" style="justify-content: flex-end;">
            <@print_slim form.ls1_textfield_18 25 />
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td class="boxes" style="justify-content: flex-end;">
            <@print_slim form.ls1_textfield_18 36 25 />
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_4?contains("Гражданином")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
    ...
    <tr>
        <td class="boxes">
            <slimbox style="border-right: 1px solid black;">${form.ls1_combobox_4?contains("Лицом")?then("V", "")}</slimbox>
            &nbsp;&nbsp;
            <span>
...
<table class="header">
    <tr>
        <td></td>
        <td class="boxes" style="justify-content: center;">ЛИСТ&nbsp;&nbsp;
            <box style="font-size:initial">Е</box>
        </td>
    </tr>
</table>
...
<table class="no-gap">
    ...
    <tr>
        ...
        <td class="boxes" style="justify-content: flex-end;">
            <@print_slim form.ls1_textfield_19 28 />
        </td>
    </tr>
</table>
...
<table class="no-gap">
    <tr>
        ...
        <td class="boxes" style="justify-content: flex-end;">
            <@print_slim form.ls1_textfield_20 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_20 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_20 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_20 34 28+34*2 />
            </span>
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>4.2.1. ОГРН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_21 13 />
        </td>
    </tr>
    <tr>
        <td>4.2.2. ИНН</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_22 12 />
        </td>
    </tr>
    ...
    <tr>
        <td>4.3. Фамилия</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_23 28 />
        </td>
    </tr>
    <tr>
        <td>4.4. Имя</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_24 28 />
        </td>
    </tr>
    <tr>
        <td>4.5. Отчество<br>(при наличии)</td>
        <td class="boxes">
            <@print_slim form.ls1_textfield_25 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
    ...
    <tr>
        <td colspan=2>
            <span class="boxes">
                4.6.1. Серия и номер
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_26 4 /> 
                &nbsp;&nbsp;
                <@print_slim form.ls1_textfield_27 6 /> 
                &nbsp;&nbsp;
                4.6.2. Дата выдачи
                &nbsp;&nbsp;
                <@print_slim form.ls1_datefield_2 2 />
                <b>&nbsp;·&nbsp;</b>
                <@print_slim form.ls1_datefield_2 2 3 />
                <b>&nbsp;·&nbsp;</b>
                <@print_slim form.ls1_datefield_2 2 8 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_28 28 />
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_28 34 28 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_28 34 28+34 />
            </span>
        </td>
    </tr>
    <tr>
        <td colspan=2>
            <span class="boxes" style="justify-content: center;">
                <@print_slim form.ls1_textfield_28 34 28+34*2 />
            </span>
        </td>
    </tr>
    <tr>
        ...
        <td class="boxes">
            <@print_slim form.ls1_textfield_29 3 />
            <b>&nbsp;-&nbsp;</b>
            <@print_slim form.ls1_textfield_29 3 3 />
        </td>
    </tr>
</table>
            ...
            <tr>
                <td colspan=2>
                    <span class="boxes">
                        ...
                        Федерации (код)
                        &nbsp;&nbsp;
                        <@print_slim clone.textfield_43 2 />
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan=2>
                    <span class="boxes">
                        ...
                        Федерации (код)
                        &nbsp;&nbsp;
                        <@print_slim clone.textfield_44 2 />
                    </span>
                </td>
            </tr>
            <tr>
